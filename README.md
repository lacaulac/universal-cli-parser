...
Local file paths are identified by either being obvious absolute paths or local paths(./example or ../example) OR based on the presence of a few extensions for file names.